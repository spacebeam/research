...
## Community
For more about how to get involved: join the [conversation](https://discord.com/invite/SFpVE5Z), build a bot to [compete](https://torchup.org) in StarCraft: Brood War or check our [guide](https://github.com/spacebeam/guide/wiki).
