...
Spacebeam follows this interpretation of [the](http://www.catb.org/esr/writings/taoup/html/ch01s06.html) UNIX philosophy: lots of small components that do one thing and talk between them by passing messages, usually text, binaries or signals.
