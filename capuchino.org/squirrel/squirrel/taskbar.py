...
class CustomTaskBarIcon(wx.TaskBarIcon):
    ...
    def __init__(self, frame):
        ...
        self.Bind(wx.EVT_TASKBAR_LEFT_DOWN, self.OnTaskBarClickMenu)
        self.Bind(wx.EVT_TASKBAR_RIGHT_DOWN, self.OnTaskBarClickMenu)
    ...
    def OnTaskBarClickMenu(self, event):
        '''
