...
require("./units/enemy")
require("./units/boss")
require("./units/magmahulk")
require("./units/gasghost")
-- gamestates
...
require("./states/keyboard")
require("./states/joystick")
require("./states/levelselection")
require("./states/summary")
-- require(./states/"highscore_entry")
require("./states/highscore_list")
...
[6]=joystick, [7]=howto, [8]=highscore_list, [9]=highscore_entry, [10]=ingame_menu, [12]=summary}
