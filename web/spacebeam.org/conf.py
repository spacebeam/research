...
BLOG_AUTHOR = "The Spacebeam authors"  # (translatable)
BLOG_TITLE = "Spacebeam"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://spacebeam.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
BASE_URL = "https://spacebeam.org/"
BLOG_EMAIL = "info@spacebeam.org"
BLOG_DESCRIPTION = "Distributed Artificial Intelligence"  # (translatable)
...
<script src="/seed/fun.utils.js"></script>
<script src="/seed/fun.configuration.js"></script>
<script src="/seed/fun.strings.js"></script>
<script src="/seed/fun.models.js"></script>

<!-- Project views -->

<script src="/views/landing.js"></script>
<script src="/views/contact.js"></script>
<script src="/views/consultancy.js"></script>
